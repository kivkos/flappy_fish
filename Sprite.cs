...
namespace OTTER
{
    ...
    public class Sprite
    {
        ...
        public virtual bool TouchingEdge()
        {
            //if (TouchingLeftEdge())
            //{
            //    return true;
        ...
        //metoda za dodir drugih riba
        public bool TouchingSprite(Druge_Ribe dr)
        {
            Sprite a = this;

            Rectangle A = new Rectangle(a.X-20, a.Y-20, a.Width-20, a.Heigth-20);
            Rectangle B = new Rectangle(dr.X-20, dr.Y-20, dr.Width-20, dr.Heigth-20);
